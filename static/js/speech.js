// ==================== SPEECH ====================
    ...
    function speakQuestion(text) {
        ...
        utterance.onend = () => {
            ...
            // Check if the interview is actually over before starting recognition again
            const caption = document.getElementById("captionText").innerText;
            if (caption.includes("completed") || caption.includes("Thank you")) {
                updateStatus("Interview Finished");
                return; // Don't start recognition if the interview is done
            }
